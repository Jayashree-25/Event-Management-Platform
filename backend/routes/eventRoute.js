...
import noAuthEventController from "../controllers/noAuthEventController.js"
import getIndiEventController from "../controllers/getIndiEventController.js"
const router = express.Router();

router.post("/events",isAuth,createEventValidate,createEventController);
router.get("/events",isAuth,getEventsController);
router.get("/noauth/events",noAuthEventController)
...
router.get("/one/:id/events",isAuth,getIndiEventController)
